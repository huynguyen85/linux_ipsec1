...
static inline void mlx5_ipsec_esp_destroy_xfrm(struct mlx5_accel_esp_xfrm *xfrm) {}

static inline void *mlx5_ipsec_create_sa_ctx(struct mlx5_core_dev *mdev,
					     struct mlx5_accel_esp_xfrm *accel_xfrm,
					     u32 *hw_handle)
{
	return NULL;
...
static inline void mlx5_ipsec_delete_sa_ctx(void *context) {}
